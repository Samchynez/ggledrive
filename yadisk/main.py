...
def main():
    # print(create_and_upload_file(file_name='чек-txt.txt', file_content='Hello Friend'))
    print(upload_dir(dir_path=r'C:\Users\s.dundukov.TCSBANK\PycharmProjects\yadisk\myfiles_supertest'))
